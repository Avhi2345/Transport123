  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        setMessage('Your email has been verified and registered successfully! Please sign in with your credentials.');
        setShowOTP(false);
        setIsSignUp(false);
        setEmail('');
        setPassword('');
    ...
    <div className="auth-wrapper">
      ...
      <div className="auth-footer">
        <div className="auth-social-links">
          <a href="#" className="auth-social-link" aria-label="Facebook" onClick={(e) => e.preventDefault()}>
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z"/>
            </svg>
          </a>
          <a href="#" className="auth-social-link" aria-label="Instagram" onClick={(e) => e.preventDefault()}>
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="#" className="auth-social-link" aria-label="YouTube" onClick={(e) => e.preventDefault()}>
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              <path d="M23.498 6.163a3.003 3.003 0 00-2.11-2.11C19.518 3.5 12 3.5 12 3.5s-7.517 0-9.388.503a3.003 3.003 0 00-2.11 2.11C0 8.033 0 12 0 12s0 3.967.502 5.837a3.003 3.003 0 002.11 2.11c1.871.503 9.388.503 9.388.503s7.518 0 9.388-.503a3.003 3.003 0 002.11-2.11C24 15.967 24 12 24 12s0-3.967-.502-5.837zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
            </svg>
          </a>
        </div>
        <div>© 2026 NE Explore. All rights reserved.</div>
      </div>
    </div>
  );
};
